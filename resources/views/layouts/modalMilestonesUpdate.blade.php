  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ URL('meilensteine')}}" method="get">
        <input type="hidden" name="_token" value="{{csrf_token()}}">
          <div class="form-group">
            <label for="recipient-name" class="control-label">Bezeichnung des Meilensteines</label>
            <input type="text" class="form-control" name="name" id="name" value="{{$ms->name}}" required>
          </div>
          <div class="form-group">
            <label for="message-text" class="control-label">Beschreibung</label>
            <textarea  class="form-control" name="description" id="description" required>{{$ms->description}}</textarea>
          </div>
          <div class="form-group">
            <label for="datetimepicker" class="control-label">Datum Fälligkeit</label>
            <div>
              <input name="duedate" type="text" id="datetimepicker" value="{{$ms->duedate}}" required />
            </div>
          </div>
